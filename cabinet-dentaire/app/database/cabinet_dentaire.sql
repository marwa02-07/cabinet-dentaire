...
-- Rendez-vous de test
INSERT INTO rendez_vous (patient_id, dentiste_id, secretaire_id, date_heure, duree_minutes, motif, type_rendez_vous, status, statut) VALUES
(1, 1, 1, NOW() + INTERVAL 1 DAY, 30, 'Consultation de contrôle', 'consultation', 'confirmed', 'confirmé'),
(1, 1, 1, NOW() + INTERVAL 7 DAY, 45, 'Nettoyage dentaire', 'nettoyage', 'pending', 'planifié');
