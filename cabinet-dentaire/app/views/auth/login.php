            ...
            <div class="login-form-section">
                ...
                <div class="login-form-header">
                    ...
                    <div style="margin-top: 20px; display: flex; gap: 10px; justify-content: center;">
                        <a href="index.php" class="btn btn-secondary" style="background-color: #6c757d; border-color: #6c757d; color: white; text-decoration: none; padding: 8px 16px; border-radius: 5px;">
                            <i class="fas fa-arrow-left"></i> Retour à l'accueil
                        </a>
                        <a href="index.php?route=/register" class="btn btn-secondary" style="background-color: #20c997; border-color: #20c997; color: white; text-decoration: none; padding: 8px 16px; border-radius: 5px;">
