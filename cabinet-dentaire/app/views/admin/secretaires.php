...
<body>
        ...
        <div class="row justify-content-center">
            <div class="col-12 col-lg-11">
                ...
                <div class="d-flex flex-wrap justify-content-between align-items-center mb-4 gap-3">
                    <h1 class="h4 mb-0">
                        <i class="fas fa-user-secret me-2 text-success"></i>Gestion des Secrétaires
                    </h1>
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div class="position-relative">
                            ...
                            <input type="text" class="form-control search-box" id="searchSecretaire" 
                                placeholder="Rechercher par nom ou email...">
                        </div>
                        <button class="btn btn-success-custom text-white" data-bs-toggle="modal" data-bs-target="#createSecretaireModal">
    ...
    <!-- Modal Création Secrétaire - Design compact -->
    <div class="modal fade" id="createSecretaireModal" tabindex="-1" aria-labelledby="createSecretaireModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header bg-success text-white py-2">
                    <h5 class="modal-title fs-6" id="createSecretaireModalLabel">
                        <i class="fas fa-user-secret me-2"></i>Nouvelle Secrétaire
                    </h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form action="index.php?route=/register-secretaire" method="POST">
