                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="numero_licence" placeholder="N° licence" value="<?php echo isset($_POST['numero_licence']) ? htmlspecialchars($_POST['numero_licence']) : ''; ?>">
                            </div>
                        </div>
                        <div class="col-md-6">
