...
$patientNomComplet = trim(($patient['prenom'] ?? '') . ' ' . ($patient['nom'] ?? ''));
$medecinNomComplet = trim(($user['prenom'] ?? '') . ' ' . ($user['nom'] ?? ''));
$patientAge = '';
...
<body>
    <div class="print-toolbar">
        <a class="btn" href="<?php echo BASE_URL; ?>index.php?route=/medecin/rendez-vous">Retour</a>
    ...
    <main class="sheet">
        <header class="header">
            ...
            <div class="cabinet-info">
                ...
                <p class="meta-line">Email: <?php echo htmlspecialchars($user['email'] ?? 'N/A'); ?></p>
            </div>
        </header>
