...
<head>
    ...
    background-attachment: fixed;
        ...
        /* Table médecins (style modernisé comme modern-table) */
#tableMedecins {
    width: 100%;
...
/* Icônes */
#tableMedecins thead th i {
    margin-right: 8px;
    color: #667eea;
}

/* Body */
#tableMedecins tbody td {
    padding: 15px 20px;
...
/* Hover rows */
#tableMedecins tbody tr {
    transition: all 0.3s ease;
}

#tableMedecins tbody tr:hover {
    background: #f8f9ff;
    transform: scale(1.01);
}

/* Actions alignées à droite */
#tableMedecins .text-end {
    text-align: right;
}

/* Padding spécial première colonne */
#tableMedecins .ps-4 {
            ...
            <div class="hero">
                <div class="d-flex flex-column flex-lg-row align-items-start align-items-lg-center justify-content-between gap-3">
                    <div>
                        ...
                        <p class="hero-sub">Rechercher, ajouter, modifier ou supprimer un médecin.</p>
                    </div>
